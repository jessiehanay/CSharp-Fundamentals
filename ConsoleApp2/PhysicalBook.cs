public class PhysicalBook : Book
{
    ...
    // Constructor:
    public PhysicalBook(string title, string author, int id, int pages, int availableCopies): base(title, author, id)
    {
        this.pages = pages;
    ...
    {
        Console.WriteLine($"Type: Physical, Id: {id}, Title: {title}, Author: {author}, Pages: {pages}, Available Copies: {availableCopies}");
    }
